...
if __name__ == "__main__":
    ...
    df_zero = filter_pocket_columns(df.copy(), target_integer=0, categorical_var="furcation",
                                    pockets_or_recession="recession")
    df_one = filter_pocket_columns(df.copy(), target_integer=1, categorical_var="furcation",
                                   pockets_or_recession="recession")
